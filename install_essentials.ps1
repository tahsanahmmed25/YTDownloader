...
if (Test-Path $ffmpegTarget -PathType Leaf -and Test-Path $ffprobeTarget -PathType Leaf) {
    $ffmpegOk = (Get-Item $ffmpegTarget).Length -gt 0
    $ffprobeOk = (Get-Item $ffprobeTarget).Length -gt 0
