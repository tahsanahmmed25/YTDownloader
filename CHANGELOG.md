...
- Auto-update checker with installer download
- Cookie support for age-restricted/private videos
- FFmpeg auto-installation for subtitle embedding

### Changed
- Improved UI responsiveness during concurrent downloads
- Better error messages for network and access issues
- Enhanced download progress tracking

### Fixed
- Memory management in concurrent mode
- Queue persistence on app crash
- Proper cleanup of temporary files

## [0.9.0] - 2026-03-01

### Initial Release
- Basic YouTube video/playlist download
- Simple UI with preview thumbnails
...
1. Check [existing issues](https://github.com/yourusername/YTDownloader/issues)
2. Open a [new issue](https://github.com/yourusername/YTDownloader/issues/new)
3. Include:
   - Windows version
